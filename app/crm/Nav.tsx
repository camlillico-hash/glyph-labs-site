...
import { Users, BriefcaseBusiness, Settings, LogOut, Handshake, Crosshair, Target, ClipboardList } from "lucide-react";
...
export default function Nav() {
  ...
  const isWorkPage = pathname.startsWith('/crm/tasks') || pathname.startsWith('/crm/activities');
  ...
  return (
    <nav className="flex items-center gap-1 pt-1 sm:pt-0 text-sm">
      ...
      <Link className={navClass(isWorkPage)} href="/crm/tasks"><ClipboardList size={18} /><span className="hidden sm:inline"> Work</span></Link>
