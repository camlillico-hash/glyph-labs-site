...
const reads = [
  ...
  },
  {
    ...
    cover: "/books/start-to-scale.jpg",
  },
  {
    ...
    <main className="coaching-theme min-h-screen bg-neutral-950 text-slate-100">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-8 pt-10 md:pb-10 md:pt-12">
        <h1 className="max-w-5xl text-4xl font-bold leading-tight tracking-tight md:text-6xl">
          Build a <span className="text-orange-200">leadership team that executes with clarity</span>, discipline, and momentum.
        </h1>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-4">
        <div className="mx-auto w-full max-w-[700px] rounded-2xl border border-neutral-600 bg-neutral-900/85 p-6 shadow-lg shadow-black/30 md:p-7">
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-slate-300">
              ...
              <p>
                ...
                space for honest dialogue, healthy debate, and aligned decision-making.
